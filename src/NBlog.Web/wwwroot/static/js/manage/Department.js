...
function initTree() {
    ...
    $.ajax({
        type: "Get",
        url: "/manage/Department/GetTreeData?_t=" + new Date().getTime(),    //获取数据的ajax请求地址
...
function loadTables(startPage, pageSize) {
    ...
    $.ajax({
        type: "GET",
        url: "/manage/Department/GetChildrenByParent?startPage=" + startPage + "&pageSize=" + pageSize + "&parentId=" + selectedId + "&_t=" + new Date().getTime(),
        success: function (data) {
...
function edit(id) {
    $.ajax({
        type: "Get",
        url: "/manage/Department/Get?id=" + id + "&_t=" + new Date().getTime(),
        success: function (data) {
            $("#Id").val(data.id);
...
function deleteMulti() {
    ...
    layer.confirm("您确认删除选定的记录吗？", {
        ...
        $.ajax({
            type: "Post",
            url: "/manage/Department/DeleteMuti",
            data: sendData,
            success: function (data) {
                if (data.result == "Success") {
                    initTree();
