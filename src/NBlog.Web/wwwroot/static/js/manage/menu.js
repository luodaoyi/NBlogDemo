...
function initTree() {
    ...
    $.ajax({
        type: "Get",
        url: "/manage/menu/getmenutreeData?_t=" + new Date().getTime(),    //获取数据的ajax请求地址
...
function loadTables(startPage, pageSize) {
    ...
    $.ajax({
        type: "GET",
        url: "/manage/getmneusbyparent?parentId=" + selectedMenuId + "&startPage=" + startPage + "&pageSize=" + pageSize + "&_t=" + new Date().getTime(),
        success: function (data) {
...
function edit(id) {
    $.ajax({
        type: "Get",
        url: "/manage/menu/get?id=" + id + "&_t=" + new Date(),
        success: function (data) {
            $("#Id").val(data.id);
